        ...
        <div className="p-4">
            ...
            <div className="flex justify-center items-center mt-6">
                <button
                    ...
                    className={`px-4 py-2 bg-blue-500 text-white rounded-md mx-2 ${currentPage === 1 ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                >
                    Previous
                </button>
                ...
                <button
                    ...
                    className={`px-4 py-2 bg-blue-500 text-white rounded-md mx-2 ${currentPage === totalPages ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                >
                    Next
                </button>
